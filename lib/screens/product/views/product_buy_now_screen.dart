...
import 'package:ecom/screens/product/views/location_permission_store_availability_screen.dart';
import 'package:ecom/screens/product/views/size_guide_screen.dart';
                  ...
                  icon: SvgPicture.asset(
                    ...
                    colorFilter: ColorFilter.mode(
                      Theme.of(context)
                          .textTheme
                          .bodyLarge!
                          .color!, // Get the text color from your theme
                      BlendMode.srcIn, // Common blend mode for solid coloring
                    ),
                  ),
                )
              ],
